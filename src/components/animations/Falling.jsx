...
export default function Falling () {
    ...
    return (
        ...
        >
            <img className='w-full relative z-50' src={coffeeWave} alt="" />
            ...
            {clouds.map((cloud, index) => (
                <img
                    ...
                    src={mwCloud}
                    alt=""
                    className='absolute scroll-animation'
                    style={{
                        top: `${cloud.top}vh`,
                        left: `${cloud.left}vw`,
            ...
            <div
                ref={characterRef}
                className='absolute top-50 left-[50%] translate-x-[-50%] z-10 w-full xl:w-6/12 scroll-animation'
            >
                <img className='w-[2000px]' src={mwFalling} alt="" />
            </div>
        </section>
    );
}
